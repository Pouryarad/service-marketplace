  ...
  return (
    <div className="space-y-6 max-w-2xl">
      ...
      <div className="rounded-2xl bg-white p-5 shadow-sm">
        ...
        {raw?.id_document_url ? (
          <a href={raw.id_document_url} target="_blank" rel="noopener noreferrer">
            <Image
              src={raw.id_document_url}
              alt="ID Document"
              width={400}
              height={250}
              className="rounded-xl w-full max-w-sm object-cover border border-black/10"
            />
          </a>
        ) : (
